...
const Header = () => {
  ...
  return (
    <header
      className={`flex-1 w-full h-[200px] max-[400px]:h-auto relative after:content-[""] after:absolute after:w-full after:h-full after:bg-black/30 after:backdrop-blur-[3px] after:top-0 after:left-0 after:z-10 p-10 max-[400px]:p-0`}
